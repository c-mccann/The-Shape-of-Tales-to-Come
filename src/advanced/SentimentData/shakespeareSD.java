 ...
 * Data Structure to Hold Sentence sentiment data for shakespearean plays
 */
public class ShakespeareSD {
    ...
    public ShakespeareSD(String character, String sentence, int sentiment, String act,
                         String scene, int playSentencePosition) {
